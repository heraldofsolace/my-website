...
export interface ApiArticleCategoryArticleCategory
  ...
  attributes: {
    blog_portfolios: Schema.Attribute.Relation<
      'manyToMany',
      'api::blog-portfolio.blog-portfolio'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAstrophotoAstrophoto extends Struct.CollectionTypeSchema {
  collectionName: 'astrophotos';
  info: {
    displayName: 'Astrophoto';
    pluralName: 'astrophotos';
    singularName: 'astrophoto';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::astrophoto.astrophoto'
    > &
      Schema.Attribute.Private;
    Location: Schema.Attribute.String;
    Multinight: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiBlogPortfolioBlogPortfolio
  extends Struct.CollectionTypeSchema {
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    starting_price: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/types' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::astrophoto.astrophoto': ApiAstrophotoAstrophoto;
