...
/**
 * Shared renderer behind both the site-wide (devrel) and /math
 * opengraph-image routes — same branding (dark bg, accent bar, actual
 * site fonts), parameterized by which persona's name/role/tagline to show.
 */
