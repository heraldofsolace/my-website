  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-1 flex-col justify-center px-6 md:px-10">
        ...
        >
          I help developer tools companies earn trust with{" "}
          <span className="text-fg">worry-free</span>{" "}
          developer marketing — writing, strategy, and content that developers
          actually read.
        </motion.p>
