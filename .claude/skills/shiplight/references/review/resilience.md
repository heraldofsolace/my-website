...
```yaml
# regression: err-01-api-error-shows-message · UX-Error-Handling · severity critical
goal: Verify API failure shows user-friendly error message instead of blank screen
